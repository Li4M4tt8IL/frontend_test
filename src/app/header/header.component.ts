...
@Component({
  selector: 'app-header',
  standalone: true,
  imports: [MatIconModule, TextComponent, CommonModule],
  template: `
  <header>
    <content>
      <div class="left">
...
<g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
  ...
  <footer>
    ...
    <content>
      <div class="left">
        <p id="text">CSS IS AWESOME</p>
        <div id="box">
        </div>
      </div>
      <div class="right">
        <button class="button" id="btn"><b>POKAŻ <span id="icon"><mat-icon>keyboard_arrow_up</mat-icon></span></b></button>
        <div id="popup">
          <p><a href="/"><mat-icon>keyboard_arrow_right</mat-icon> ZRESETUJ USTAWIENIA</a></p>
          <p (click)="personalInfo()"><mat-icon>keyboard_arrow_right</mat-icon> POKAŻ DANE OSOBOWE</p>
        </div>
      </div>
    </content>
  </footer>
...
export class HeaderComponent {
  ...
  textList:string[] = ["Zadanie <b>rekrutacyjne</b>"]
  personalInfo() {
    if(!this.isShown()) {
      this.textList.push("Liam Bilowicki");
